...
},{}],"src/prijava.js":[function(require,module,exports) {
"use strict";
...
function prijava() {
  ...
  var prijava = false; //gleda da li se korisnik uspio prijaviti tj. da li je ispravno i username i password
  ...
  database.collection("korisnici").where("username", "==", username.value).get().then(function (querySnapshot) {
    querySnapshot.forEach(function (doc) {
      ...
      if (podaci.password == password.value) {
        console.log("Uspjesna prijava ".concat(podaci.username));
...
function registracija() {
  var database = firebase.firestore();
  var vecZauzeto = false; //provjerava je li username vez zauzet
  ...
  database.collection("korisnici").get().then(function (querySnapshot) {
    ...
    if (vecZauzeto == true) {
      ...
      console.log("".concat(username.value, ", uspje\u0161no ste se registrirali "));
...
},{"./baseComponent":"src/baseComponent.js","./modelAndControler":"src/modelAndControler.js"}],"../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","src/prijava.js"], null)
//# sourceMappingURL=/prijava.2d6316d6.js.map