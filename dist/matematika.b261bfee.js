...
},{}],"KAAmh":[function(require,module,exports) {
  ...
  querySnapshot.forEach(doc => {
    ...
    korisnik.oglasi.forEach(el => {
      if (el.predmet == "matematika") {
        let oglas = new _componentsIspisOglasaDefault.default(korisnik.kontakt, el.opis, korisnik.lokacija, el.cijena, el.razina, el.ocjena.like, el.ocjena.dislike, el.id, korisnik.username);
